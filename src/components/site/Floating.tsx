  ...
  return (
    <div className="fixed bottom-24 right-4 z-40 flex flex-col gap-3 md:bottom-6">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-white border border-amber-100 shadow-warm transition-transform hover:scale-110 hover:text-primary active:scale-95"
        aria-label="Call"
      >
      ...
      <a
        href="/#contact"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-white text-foreground shadow-elegant transition-transform hover:scale-110 active:scale-95"
        aria-label="Location"
      >
