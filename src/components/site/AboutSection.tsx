      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-2 md:items-center">
        <div className="reveal relative">
          ...
          <div className="overflow-hidden rounded-3xl shadow-elegant border border-border">
            <img src={settings?.about_image_url || "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=800&q=80"} alt="Arabica Coffee House & Restaurant" className="h-full w-full object-cover" loading="lazy" />
          </div>
