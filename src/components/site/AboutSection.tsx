        ...
        <div className="reveal">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3">
            {STATS.map((s) => (
              <div
                key={s.l}
                className="rounded-2xl bg-black/50 backdrop-blur-xl border border-red-900/40 px-4 py-5 shadow-2xl hover:border-red-500/50 hover:shadow-[0_0_20px_rgba(220,38,38,0.2)] hover:-translate-y-1 transition-all duration-300 group"
              >
