                ...
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <span className="text-lg font-black text-white bg-primary/80 backdrop-blur-md px-3 py-1 rounded-full border border-primary/20 shadow-inner">{formatPrice(m.price)}</span>
                      <button
                        onClick={() => add(m)}
