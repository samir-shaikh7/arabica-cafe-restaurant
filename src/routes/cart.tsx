          ...
          {items.length === 0 ? (
            ...
            <div className="animate-fade-in">
              <button
                ...
                className="flex items-center gap-2 text-sm font-semibold text-foreground/60 hover:text-primary mb-6 transition-colors"
              >
                          ...
                          <div className="flex-1 min-w-0 py-1">
                            ...
                            <div className="mt-3 flex items-center gap-3">
                              <div className="inline-flex items-center gap-2 rounded-full border border-border px-2 py-1">
                                ...
                                <button
                                  onClick={() => setQty(i.id, i.qty + 1)}
                                  className="flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-muted hover:bg-primary/20 hover:text-primary transition-colors"
                                >
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="relative">
                                      <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-primary/60" />
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <div className="relative">
                                      <MapPin className="absolute left-4 top-4 h-5 w-5 text-primary/60" />
                                ...
                                <FormControl>
                                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    >
                                      ...
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "cash" ? "bg-primary text-white" : "bg-muted text-foreground/60"}`}>
                                    ...
                                    >
                                      ...
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "gcash" ? "bg-primary text-white" : "bg-muted text-foreground/60"}`}>
                                    ...
                                    >
                                      ...
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "link" ? "bg-primary text-white" : "bg-muted text-foreground/60"}`}>
