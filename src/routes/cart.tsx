...
function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-atmosphere text-foreground flex flex-col">
      <Navbar />
        ...
        <div className="max-w-5xl mx-auto">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center min-h-[50vh] text-center animate-fade-in">
              <div className="h-24 w-24 rounded-full bg-white shadow-soft flex items-center justify-center mb-6">
                <ShoppingBag className="h-10 w-10 text-red-600/60" />
              </div>
              ...
              <Link
                to="/"
                className="rounded-full bg-gradient-to-r from-red-600 to-red-800 px-8 py-3.5 font-bold tracking-wide text-white shadow-[0_0_15px_rgba(220,38,38,0.3)] hover:scale-105 transition-transform"
              >
                Explore Menu
              </Link>
            </div>
            ...
            <div className="animate-fade-in">
              <button
                ...
                className="flex items-center gap-2 text-sm font-semibold text-foreground/60 hover:text-red-600 mb-6 transition-colors"
              >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  {step === 1 ? (
                    <div className="space-y-4">
                      {items.map((i) => (
                        <div
                          key={i.id}
                          className="flex items-center gap-4 p-4 bg-white rounded-3xl shadow-soft border border-border/50 animate-fade-in"
                        >
                          ...
                          <div className="flex-1 min-w-0 py-1">
                            ...
                            <div className="mt-1 font-black text-red-600 text-sm sm:text-base">
                            ...
                            <div className="mt-3 flex items-center gap-3">
                              <div className="inline-flex items-center gap-2 rounded-full border border-border px-2 py-1">
                                ...
                                <button
                                  onClick={() => setQty(i.id, i.qty + 1)}
                                  className="flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-muted hover:bg-red-100 hover:text-red-600 transition-colors"
                                >
                          ...
                          <button
                            onClick={() => remove(i.id)}
                            className="p-3 text-foreground/40 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors self-start sm:self-center"
                          >
                      ...
                      <div className="pt-2">
                        <button
                          onClick={clear}
                          className="text-sm font-semibold text-foreground/50 hover:text-red-500 transition-colors uppercase tracking-wider"
                        >
                          Clear All Items
                        </button>
                      </div>
                    ...
                    <Form {...form}>
                      <form id="checkout-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        {/* 1. Personal Details */}
                        <div className="bg-white rounded-3xl shadow-soft border border-border/50 p-6 sm:p-8">
                          <div className="flex items-center gap-3 mb-6">
                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-700 text-white font-bold">1</div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <div className="text-xs font-bold text-foreground/50 uppercase tracking-wider mb-2">Full Name</div>
                                  <FormControl>
                                    <div className="relative">
                                      <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-red-600/60" />
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <div className="text-xs font-bold text-foreground/50 uppercase tracking-wider mb-2">Phone Number</div>
                                  <FormControl>
                                    <div className="relative">
                                      <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-red-600/60" />
                        ...
                        <div className="bg-white rounded-3xl shadow-soft border border-border/50 p-6 sm:p-8">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                            <div className="flex items-center gap-3">
                              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-700 text-white font-bold">2</div>
                          ...
                          <div className="space-y-5">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <div className="text-xs font-bold text-foreground/50 uppercase tracking-wider mb-2">Complete Address</div>
                                  <FormControl>
                                    <div className="relative">
                                      <MapPin className="absolute left-4 top-4 h-5 w-5 text-red-600/60" />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <div className="text-xs font-bold text-foreground/50 uppercase tracking-wider mb-2">Landmark (Optional)</div>
                                    <FormControl>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <div className="text-xs font-bold text-foreground/50 uppercase tracking-wider mb-2">Order Notes</div>
                                    <FormControl>
                        ...
                        <div className="bg-white rounded-3xl shadow-soft border border-border/50 p-6 sm:p-8">
                          <div className="flex items-center gap-3 mb-6">
                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-700 text-white font-bold">3</div>
                                ...
                                <FormControl>
                                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    >
                                      ...
                                      {field.value === "cash" && <div className="absolute right-3 top-3 h-3 w-3 rounded-full bg-red-600" />}
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "cash" ? "bg-red-600 text-white" : "bg-muted text-foreground/60"}`}>
                                        <Banknote className="h-6 w-6" />
                                      </div>
                                      <span className="font-bold text-sm text-center">Cash on Delivery</span>
                                      <span className="text-[10px] text-foreground/50 font-semibold uppercase tracking-wider mt-1">Safe & Simple</span>
                                    </label>
                                    ...
                                    >
                                      ...
                                      {field.value === "gcash" && <div className="absolute right-3 top-3 h-3 w-3 rounded-full bg-red-600" />}
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "gcash" ? "bg-red-600 text-white" : "bg-muted text-foreground/60"}`}>
                                        <Wallet className="h-6 w-6" />
                                      </div>
                                      <span className="font-bold text-sm text-center">G-Cash</span>
                                      <span className="text-[10px] text-foreground/50 font-semibold uppercase tracking-wider mt-1">Quick & Easy</span>
                                    </label>
                                    ...
                                    >
                                      ...
                                      {field.value === "link" && <div className="absolute right-3 top-3 h-3 w-3 rounded-full bg-red-600" />}
                                      <div className={`h-12 w-12 rounded-full mb-3 flex items-center justify-center ${field.value === "link" ? "bg-red-600 text-white" : "bg-muted text-foreground/60"}`}>
                                        <CreditCard className="h-6 w-6" />
                                      </div>
                                      <span className="font-bold text-sm text-center">Payment Link</span>
                                      <span className="text-[10px] text-foreground/50 font-semibold uppercase tracking-wider mt-1">Secure Pay</span>
                                    </label>
                                  </div>
                                </FormControl>
                              </FormItem>
                ...
                <div className="lg:col-span-4">
                  <div className="bg-white rounded-[2rem] shadow-elegant border border-border/50 p-6 sm:p-8 sticky top-28">
                    <h2 className="text-xl sm:text-2xl font-bold mb-6">Order summary</h2>

                    <div className="space-y-4 text-sm font-semibold text-foreground/70 mb-6">
                    ...
                    <div className="border-t border-border/50 pt-5 pb-5">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-black text-red-600">KD {finalTotal.toFixed(3)}</span>
                      </div>
                    </div>
                    ...
                    {minOrderNotMet ? (
                      ...
                      <div className="mb-6 rounded-full bg-amber-50 border border-amber-100 py-3 text-center text-[13px] font-bold text-amber-600">
                    ...
                    {step === 1 ? (
                      <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 rounded-full px-6 py-4 text-base font-bold text-white transition-all ${minOrderNotMet
                            ...
                            : "bg-gradient-to-r from-red-600 to-red-800 shadow-[0_0_15px_rgba(220,38,38,0.4)] hover:scale-[1.02] active:scale-[0.98]"
                          }`}
                      >
                    ...
                    <div className="mt-6 text-center text-[10px] uppercase tracking-widest font-bold text-foreground/40">
