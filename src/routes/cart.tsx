    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          toast.error("Error finding your location.");
        } finally {
          setIsLocating(false);
        }
      },
                  ...
                  <div className="bg-card rounded-[2rem] shadow-elegant border border-border/50 p-6 sm:p-8 sticky top-28">
                    ...
                    {minOrderNotMet ? (
                      ...
                      <div className="mb-6 rounded-full bg-secondary border border-border py-3 text-center text-[13px] font-bold text-primary">
                        Add {formatPrice(FREE_DELIVERY_THRESHOLD - subtotal)} more for <span className="underline decoration-2 underline-offset-2">free delivery</span>.
                      </div>
                    ) : null}
