    ...
    const fetchSiteData = async () => {
      ...
      const settings: SiteSettings = settingsRaw
          ? {
              ...
              about_heading: (settingsRaw as any).about_heading || "",
              about_description: (settingsRaw as any).about_description || "",
              about_image_url: (settingsRaw as any).about_image_url || "",
            }
          : DEFAULT_SETTINGS;
